...
class AddMembersActivity : AppCompatActivity() {
    ...
    val binding: ActivityAddMembersBinding by lazy {
        ActivityAddMembersBinding.inflate(layoutInflater)
    }
    ...
    val requestPermissions = registerForActivityResult(RequestMultiplePermissions()) { results ->
        ...
        if (permission) {
            ...
            ViewController.showToast(this@AddMembersActivity, "Accept permissions")
        }
    }
...
//        }
    ...
    private fun addMemberApi() {
        ...
        ViewController.hideKeyBoard(this@AddMembersActivity )
        ...
        if (!ViewController.validateEmail(email)) {
            ...
            ViewController.showLoading(this@AddMembersActivity)

            val apiServices = RetrofitClient.apiInterface
            val call =
                apiServices.addMemberApi(
                    ...
                    try {
                        if (response.isSuccessful) {
                            ...
                            if (response.body()?.status == true){
                                ...
                                val intent = Intent(this@AddMembersActivity, DashBoardActivity::class.java)
                            ...
                            ViewController.customToast(applicationContext, "Members adding Failed")
                        }
