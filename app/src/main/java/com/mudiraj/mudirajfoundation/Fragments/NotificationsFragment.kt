...
import com.mudiraj.mudirajfoundation.databinding.FragmentNotificationsBinding
...
class NotificationsFragment : Fragment() {
    ...
    private lateinit var notificationsList: MutableList<FavouriteResponse>
            ...
            override fun onResponse(call: Call<FavouriteModel>, response: Response<FavouriteModel>) {
                try {
                    if (response.isSuccessful) {
                        notificationsList = response.body()?.response!!
    ...
    private fun DataSet() {
        ...
        binding.recyclerview.adapter = NotificationsAdapter(requireActivity(), notificationsList)
    }
